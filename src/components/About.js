      ...
      <div className='about'>
        <div className='wrapper'>
          ...
          <ul>
            ...
            <li>Version control and open-sourcing code using Git and Github</li>
          ...
          <p>
            ...
            career and experience illustrates a devotion to perpetual growth and
            a passion for exploring.
          </p>
          <p>
            Prior to his present career, Dan worked variously in the fields of
            sales, construction, and sanitation. Along the way acquiring a rich
            tool kit of transferable skills in project development, management,
            administration and workflow optimization. Dan has also built solid
            strategies for effective engagement with all staff and stakeholders
            around him. Dan enjoyed success in these roles, however after
            developing an interest in the world of programming it became clear
            to him that this was where his true passion lay.
          </p>
          <p>
